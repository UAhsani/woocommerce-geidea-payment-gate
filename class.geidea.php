...
class WC_Gateway_Geidea extends WC_Payment_Gateway {
  ...
  public function init_form_fields() {   
      ...
      $this->form_fields = array(
        ...
        'logo' => array(
          ...
          'type' => 'file',
          'description' => '<img src="' . $icon . '?v='.(!empty($_POST['woocommerce_geidea_logo']) ? rand(1000, 9999) : '').'" width="70">',
  ...
  function receipt_page($order_id) {
      ...
      $save_card = false;
      if(isset($_GET['save_card']) && $_GET['save_card'] == "true"){
          $save_card = true;
      }
  ...
  function need_to_save_new_card($user_id){
      $token_id = $_POST[$this->token_id_param];
      $save_token = $_POST[$this->tokenise_param];
